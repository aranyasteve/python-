...
class Analog:
    def __init__(self, root):
        self.root = root
        self.root.config(bg="#a1b3b0")
        self.root.geometry("700x700")
        self.root.title("World Time")
        self.root.resizable(height=False, width=False)
        self.L = Label(top, text="World Time", font=10, bg="#a1b3b0", fg="white")
        self.L.place(x=320, y=0)
        self.L1 = Label(top, text="Continent Name: ", font=5, bg="#a1b3b0", fg="white")
        self.L1.place(x=160, y=70)
        self.L2 = Label(top, text="City Name: ", font=5, bg="#a1b3b0", fg="white")
        self.L2.place(x=170, y=140)
        self.L3 = Label(text="", font=10, bg="#a1b3b0", fg="white")
        self.L3.place(x=220, y=210)
        self.B = Button(top, text="Check", font=10, relief=SUNKEN, width=30, bg="#dedede", command=self.get_time)
        self.B.place(x=216, y=650)
